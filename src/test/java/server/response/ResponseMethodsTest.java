...
public class ResponseMethodsTest {
    @Test
    public void shouldBuildABasicResponse() {
        Request request = new Request("HEAD", "/test-route", new HashMap<>(), "");
        Response response = ResponseMethods.render(request, "test body".getBytes());
    ...
    public void shouldBuildAResponseGivenARoute() {
        Request request = new Request("GET", "/test-route", new HashMap<>(), "");
        Response response = ResponseMethods.fromRoute(request, RoutesStub.ROUTES.get("/test-route"));
    ...
    public void shouldBuildA301MovedPermanentlyResponse() {
        ...
        Response response = ResponseMethods.redirectTo(request, "/new-path");
    ...
    public void shouldBuildAResponseWithCustomHeaders() {
        ...
        Request request = new Request("GET", "/test-route", new HashMap<>(), "");
        Response response = ResponseMethods.render(request, "".getBytes(), customHeaders);
    ...
    public void shouldBuildAResponseWithDirectoryIndex() {
        ...
        Response response = ResponseMethods.renderDirectory(request, path);
    ...
    public void shouldBuildAResponseWithTextFileContents() {
        ...
        String directoryPath = "./src/test/java/stubs/app/public_stub";
        Response response = ResponseMethods.renderFile(request, directoryPath + request.path());
